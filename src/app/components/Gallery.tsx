...
export default function Gallery() {
  ...
  // مدیریت لایتباکس: فوکوس اولیه، قفل اسکرول، بستن با Esc، جابه‌جایی با
  // فلش‌های کیبورد، چرخش فوکوس با Tab و برگرداندن فوکوس هنگام بستن
  useEffect(() => {
    if (!isOpen) return;
  ...
  return (
    ...
    >
      ...
      {/* لایتباکس — نمایش تمام‌صفحه‌ی عکس با کلیک */}
