...
type ScrollExpandConfig = Required<
  Pick<
    ScrollExpandProps,
    | "startWidth"
    | "startHeight"
...
const ScrollExpand = ({
  ...
  // Config در effect داخل ref همگام‌سازی می‌شود — نه حین render (قانون react-hooks/refs)
  ...
  useEffect(() => {
    ...
    const scroller: HTMLElement | Window = configRef.current.useWindowScroll
      ? window
      : root;
